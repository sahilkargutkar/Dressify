...
const UpdateOrder = ({ history, match }) => {
  ...
  }, [dispatch, toast, error, match.params.id, isUpdated, error, updateError]);
      ...
      {loading ? (
        ...
        <>
          <form
            ...
            class="flex flex-wrap bg-gray-100 w-full h-screen"
          >
            <div class="w-3/12 bg-white rounded p-3 shadow-lg">
              <div class="flex flex-col">
                <label class="leading-loose mb-4">Update Order</label>
                {/* <input
                      type="text"
